...
1.Copy paste the URL `http:ADDC01.corp.devlab.com/certsrv/` in PVWACPM03 server.
We are going to download CA certificate from Domain Controller server and import into vault server.
